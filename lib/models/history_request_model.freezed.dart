...
as MQTTRequestModel?,httpResponseModel: null == httpResponseModel ? _self.httpResponseModel : httpResponseModel // ignore: cast_nullable_to_non_nullable
...
class _HistoryRequestModel implements HistoryRequestModel {
  const _HistoryRequestModel({required this.historyId, required this.metaData, this.httpRequestModel, this.aiRequestModel, this.wsRequestModel, this.mqttRequestModel, required this.httpResponseModel, this.preRequestScript, this.postRequestScript, this.authModel});
